    ...
    <ul class="nav">
        ...
        <li class="nav-item {{ Request::is('admin/category*') ? 'active': ''}}">
            ...
            <div class="collapse {{ Request::is('admin/category*') ? 'show': ''}}" id="category">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link {{ Request::is('admin/category') || Request::is('admin/category/*/edit') ? 'active': ''}}" href="{{ url('admin/category/create') }}? 'active': ''}}" href="{{ url('admin/category/create') }}" href="{{ url('admin/category') }}">View Category</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item {{ Request::is('admin/products*') ? 'active': ''}}">
            ...
            <div class="collapse {{ Request::is('admin/products*') ? 'true': 'false'}}" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link {{ Request::is('admin/products/create') ? 'active': ''}}" href="{{ url('admin/products/create') }}">Add Product</a>
                    </li>
